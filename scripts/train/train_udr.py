"""UDR training script - Uniform Domain Randomization with fixed ±30% ranges."""
...
def main():
    ...
    # Create environments (source with UDR enabled)
    ...
    print(f'=== UDR TRAINING ±30% (Seed: {SEED}) ===')
    ...
    # Save
    model.save(os.path.join(log_dir, "ppo_hopper_udr"))
